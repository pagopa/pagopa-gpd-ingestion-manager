...
async function insertTransfer(id, companyName, paymentOptionId) {
  await connection.query(`INSERT INTO apd.apd.transfer (id, amount, category, iban, transfer_id, inserted_date, iuv, last_updated_date, organization_fiscal_code, postal_iban, remittance_information, status, payment_option_id, hash_document, stamp_type, provincial_residence, company_name) VALUES('${id}', 10000, '9/0101108TS/', 'mockIban', '1', '2024-11-12 16:09:43.477', '09455575462301733', '2024-11-12 16:09:43.477', '77777777777', NULL, 'Rata 1 Edit', 'T_UNREPORTED', ${paymentOptionId}, NULL, NULL, NULL, '${companyName}');`);
}

async function updateTransfer(id, companyName) {
  await connection.query(`UPDATE apd.apd.transfer SET company_name='${companyName}' WHERE id='${id}'`);
}
